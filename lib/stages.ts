...
export const STAGES: StageDefinition[] = [
  ...
  },
  {
    ...
    summary: 'Review the AI-generated proposal, make any edits, then send it to the client with the ClubSheIs About Us PDF attached.',
    color: '#2563EB',
    ...
    substeps: [],
    dataFields: [
      { key: 'proposal_status', label: 'Proposal status', placeholder: 'Select status', type: 'select', options: ['Draft', 'Sent', 'Viewed', 'Accepted', 'Declined', 'Revising'] },
    ],
    conditionalLogic: [
    ...
    nextActionPrompt: 'Proposal sent. Waiting for client response.',
  },
  {
    key: 'onboarding',
    num: '3',
