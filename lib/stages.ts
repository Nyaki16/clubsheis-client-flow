...
export const STAGES: StageDefinition[] = [
  ...
  },
  {
    ...
    summary: 'The deep dive. Record the session, then upload the transcript to build the Client Profile and Research Bible. These documents power everything that follows.',
    color: '#9333EA',
    ...
    guide: [
      ...
      'After the session, upload the transcript and use it to build the Client Profile and Research Bible.',
      'Confirm the package scope and any adjustments before closing.',
    ],
    substeps: [],
    dataFields: [
      { key: 'session_completed', label: 'Session completed', placeholder: 'Select', type: 'select', options: ['Yes', 'No'] },
      { key: 'session_transcript_link', label: 'Session transcript / notes', placeholder: 'Paste Google Drive link or notes...', type: 'textarea' },
      { key: 'client_profile_status', label: 'Client Profile', placeholder: 'Select status', type: 'select', options: ['Not Started', 'Building', 'Complete'] },
      { key: 'client_profile_link', label: 'Client Profile link', placeholder: 'Google Drive link', type: 'text' },
      { key: 'research_bible_status', label: 'Research Bible', placeholder: 'Select status', type: 'select', options: ['Not Started', 'Building', 'Complete'] },
      { key: 'research_bible_link', label: 'Research Bible link', placeholder: 'Google Drive link', type: 'text' },
    ],
    conditionalLogic: [
      { condition: 'Client Profile + Research Bible complete', result: 'Move to the production branch based on package' },
    ...
    nextActionPrompt: 'Upload the session transcript, then build the Client Profile and Research Bible before moving to production.',
  },
  {
    key: 'page-build',
    num: '5A',
