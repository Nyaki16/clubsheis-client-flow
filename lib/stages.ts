...
export const STAGES: StageDefinition[] = [
  ...
  },
  {
    ...
    dataFields: [
      ...
      { key: 'primary_offer', label: 'Primary Offer', placeholder: 'e.g. Free Estimate, Free Consultation, Discount, Same Day Service', type: 'text' },
      { key: 'main_goal', label: 'Main Goal', placeholder: 'e.g. Generate Leads, Book Appointments, Sales', type: 'text' },
      { key: 'target_audience', label: 'Target Audience', placeholder: 'e.g. Homeowners, Business Owners, Local Customers, High-End Clients', type: 'text' },
      { key: 'brand_style', label: 'Brand Style', placeholder: 'e.g. Luxury, Modern, Trustworthy, Professional, Friendly', type: 'text' },
      { key: 'main_cta', label: 'Main CTA', placeholder: 'e.g. Book Now, Get Quote, Call Now, Schedule Consultation', type: 'text' },
      { key: 'business_hours', label: 'Business Hours', placeholder: 'Insert hours', type: 'text' },
      { key: 'communication_channels', label: 'Communication Channels', placeholder: 'e.g. SMS, Email, Phone, Web Chat, Facebook, Instagram', type: 'text' },
