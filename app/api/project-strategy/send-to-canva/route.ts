...
export async function POST(req: NextRequest) {
  try {
    ...
    await supabase.from('flow_stage_data').upsert([
      { client_id: clientId, stage_key: 'project-strategy', field_key: 'canva_design_url', field_value: result.designUrl, updated_at: now },
      { client_id: clientId, stage_key: 'project-strategy', field_key: 'canva_design_id', field_value: result.designId || '', updated_at: now },
      { client_id: clientId, stage_key: 'project-strategy', field_key: 'canva_sent_at', field_value: now, updated_at: now },
    ], { onConflict: 'client_id,stage_key,field_key' })
